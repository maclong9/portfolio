...
struct PersonalSetup: HTML {
  func render() -> String {
    Article {
      ...
      ArticleSection(title: "Workstation") {
        ContentStack(title: "14\" MacBook Pro, M3 Pro, 18GB RAM") {
          Text {
      ...
      ArticleSection(title: "Development Tools") {
        ContentStack(title: "Vim") {
          Text {
