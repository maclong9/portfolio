    ...
    var body: some Markup {
        Stack(
            ...
            Stack(
                ...
                Stack(classes: ["flex", "items-center", "justify-between", "mb-4"]) {
                    Heading(.title, "Share Your Data", classes: ["text-xl", "font-semibold", "text-zinc-900", "dark:text-zinc-100"])
                    Button(
                        onClick: onClose,
                        classes: [
                            "text-zinc-500", "hover:text-zinc-700", "dark:text-zinc-400", "dark:hover:text-zinc-200"
                ...
                Stack(classes: ["space-y-3"]) {
                    ...
                    Stack(
                        ...
                        Stack(classes: ["flex", "items-center", "gap-2"]) {
                            MarkupString(
                                content: "<input type=\"text\" id=\"share-url-input\" readonly class=\"flex-1 p-2 border border-zinc-300 dark:border-zinc-600 bg-gray-50 dark:bg-gray-700 text-zinc-900 dark:text-zinc-100 rounded text-sm font-mono\">"
                            )
                            Button(
